    ...
    <>
      ...
      <div className="container">
        ...
        <div className="link-to-stock-manager">
          <Link
            href="https://stock-portfolio-manager-psi.vercel.app/ukstock"
            replace
          >
            Stock Portfolio Manager App
          </Link>
        </div>
        ...
        <table className="table">
          <thead className="bg-dark">
            <tr style={{ fontSize: "0.7rem" }}>
              ...
              <th className="bs-primary">Market Cap (£)</th>{" "}
              {/* Changed to Million GBP */}
          ...
          <tbody>
            {filteredData.map((crypto) => (
              <tr key={crypto.id}>
                ...
                <td style={{ fontSize: "0.7rem" }}>
                  {(crypto.current_price * inrToGbpRate).toLocaleString(
                    undefined,
                ...
                <td style={{ fontSize: "0.7rem" }}>
                  {(crypto.market_cap * inrToGbpRate).toLocaleString(
                    undefined,
                    { minimumFractionDigits: 0, maximumFractionDigits: 0 }
                  )}
                </td>{" "}
                {/* Convert Market Cap to Million GBP */}
                <td
                  style={{
                    color:
